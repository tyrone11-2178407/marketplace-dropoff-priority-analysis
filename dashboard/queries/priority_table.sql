...
issue_scores AS (
  SELECT
    ...
    5 AS impact_score,
    CASE WHEN late_rate_pct >= 8 THEN 4 WHEN late_rate_pct >= 4 THEN 3 ELSE 2 END AS frequency_score,
    'Medium' AS effort,
  ...
  SELECT
    'Cancellations',
    CASE WHEN canceled_order_value >= 100000 THEN 4 WHEN canceled_order_value >= 50000 THEN 3 ELSE 2 END,
    CASE WHEN cancellation_rate_pct >= 2 THEN 4 WHEN cancellation_rate_pct >= 1 THEN 3 ELSE 2 END,
    'Medium',
    'Seller Operations',
  ...
  SELECT
    'Seller friction',
    CASE WHEN high_friction_sellers >= 20 THEN 4 WHEN high_friction_sellers >= 10 THEN 3 ELSE 2 END,
    CASE WHEN avg_high_friction_seller_late_rate >= 20 THEN 4 WHEN avg_high_friction_seller_late_rate >= 15 THEN 3 ELSE 2 END,
    'Medium',
    'Seller Operations',
  ...
  SELECT
    'Category friction',
    CASE WHEN avg_high_pain_category_low_review_rate >= 22 THEN 4 WHEN avg_high_pain_category_low_review_rate >= 18 THEN 3 ELSE 2 END,
    CASE WHEN high_pain_categories >= 5 THEN 4 WHEN high_pain_categories >= 3 THEN 3 ELSE 2 END,
    'Medium',
    'Logistics / Ops',
  ...
  SELECT
    'Payment friction',
    CASE WHEN low_review_rate_pct >= 16 THEN 2 ELSE 1 END,
    CASE WHEN orders >= 3000 THEN 2 ELSE 1 END,
    'Low',
    'Product / Checkout',
